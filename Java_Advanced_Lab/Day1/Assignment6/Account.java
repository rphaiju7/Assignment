package Java_Advanced_Lab.Day1.Assignment6;
...
class Main {
    public static void main(String[] args) {
        Account account = new Account("Suresh", "Thapa", "Maharjan", "abc@def.com", "Salary",
                "11-05-1989", 'M', "Married", 58971269);

        if (account.getAccType().equalsIgnoreCase("Salary")) {
            Salary accountEmployee = new Salary("Paul", "J", "Anderson", "Paul@Wellsfargo.com", "Salary",
                    "01-03-1985", 'M', "Single", 15684432);
            accountEmployee.setAccType("Salary");
            accountEmployee.displayDetails();
        } else {
            nonSalary nonSalary = new nonSalary("John", "", "Jacob", "John@Wellsfargo.com", "Non-Salary",
                    "03-06-1985", 'M', "Married", 54233353);
